...
public class GameController : MonoBehaviour
{
    ...
    //private List<string> bossLevelsList = ["CaveFearBoss"];
    string[] bossLevelsList = new string[] {"CaveFearBoss"} ; 
    ...
    public void NextLevel()
    {
        if(currentLevel == 1)
        {
            SceneManager.LoadScene(bossLevelsList[0]);
        }

        else
        {
            SceneManager.LoadScene("CaveGenLvL01");
        }
    }
