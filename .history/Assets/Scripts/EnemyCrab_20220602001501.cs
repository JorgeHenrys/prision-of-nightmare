...
public class EnemyCrab : MonoBehaviour
{
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Vector2 formLeft = collPoint.TransformDirection(Vector2.left) * rangeDetect;
        Vector2 formRight = collPoint.TransformDirection(Vector2.right) * rangeDetect;
        Gizmos.DrawRay(collPoint.position, formLeft);
        Gizmos.color = Color.blue;
        Gizmos.DrawRay(collPoint.position, formRight);
    }
}
