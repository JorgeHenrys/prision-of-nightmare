...
public class LevelGeneration : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(gameController.totalEnemies >= 0 && deadEveryEnemies == true && stopGeneration == true)
        {
    ...
    private void LoadEnemiesDeads()
    {
        ...
        Instantiate(portalNextLevel, player.transform.position + new Vector3(0f, 3f, 0f), Quaternion.identity);
